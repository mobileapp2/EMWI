...
EditText receiptno;
    ...
    String strdate,stramout,strrn,strdes,strtotalprise,m_selectedPath,filenamestr,strqty,strempty;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        etdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(CashFragment.this.getContext(), date, myCalendar
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(validateAmount() && validatedate() && validateRn() &&  validatedes() ){
                       callsubmit();
                }
            }
        });
cf.setOnClickListener(new View.OnClickListener() {
    ...
    public void onActivityResult( int requestCode,  int resultCode, Intent data) {
        ...
        if (requestCode == SELECT_PICTURE && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            Toast.makeText(CashFragment.this.getContext(), "Select Payment Slip",
                    LENGTH_SHORT).show();
        }
    }
    ...
    private void callsubmit() {
        ...
        if(length < 800){
            okhttp3.RequestBody dt = okhttp3.RequestBody.create(okhttp3.MediaType.parse("text/plain"),"cash");
...
//            body = MultipartBody.Part.createFormData("file", file.getName().replace(" ", "_"), requestFile);
            ...
            if(m_selectedPath != null){
               ...
               okhttp3.RequestBody attachmentEmpty = okhttp3.RequestBody.create(okhttp3.MediaType.parse("text/plain"), strempty);
            ...
            Call<SendMultiplePinResponseModel> call = apiService.wsSendPinRequest("Bearer " + SharedPreferenceUtils.getAccesstoken(CashFragment.this.getContext()),map,body);
            ...
            Toast.makeText(CashFragment.this.getContext(), "Max Photo Size: 800 K.B.", LENGTH_SHORT).show();
        }
    ...
    private boolean validatedes() {
        ...
        if (strdes.isEmpty() ) {
            Toast.makeText(CashFragment.this.getContext(), "Enter Valid Description", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
    ...
    private boolean validateRn() {
        ...
        if (strrn.isEmpty() ) {
            Toast.makeText(CashFragment.this.getContext(), "Enter Valid Receipt No", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
    ...
    private boolean validatedate() {
        ...
        if (strdate.isEmpty() ) {
            Toast.makeText(CashFragment.this.getContext(), "Enter Valid Date", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
    ...
    private boolean validateAmount() {
        ...
        if (stramout.isEmpty() ) {
            Toast.makeText(CashFragment.this.getContext(), getString(R.string.enter_amount), Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
...
//            getusercartitem();
    ...
    private void getusercartitem() {
        ...
        final Call<UserCartResponseModel> loginCall = apiService.wsGetUserCart(
                "Bearer " + SharedPreferenceUtils.getAccesstoken(CashFragment.this.getContext()));
...
//                            recycler_view_addtocart.setAdapter(addToCartAdapter);
            ...
            public void onFailure(Call<UserCartResponseModel> call,
                                  Throwable t) {
                Toast.makeText(CashFragment.this.getContext(), getString(R.string.something_went_wrong), Toast.LENGTH_SHORT).show();
            }
        });
    }
