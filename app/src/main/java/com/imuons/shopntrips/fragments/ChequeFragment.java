...
public class ChequeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        etdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(ChequeFragment.this.getContext(), date, myCalendar
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(validateAmount() && validatedate() && validateRn() &&  validatedes() && validateBank() && validateCheeque()){
                    callsubmit();
                }
            }
        });
    ...
    private boolean validateCheeque() {
        ...
        if (strcheque.isEmpty() ) {
            Toast.makeText(ChequeFragment.this.getContext(), "Enter Valid Cheque Number", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
    ...
    private boolean validateBank() {
        ...
        if (strbank.isEmpty() ) {
            Toast.makeText(ChequeFragment.this.getContext(), "Enter Valid Bank Name", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
    ...
    public void onActivityResult( int requestCode,  int resultCode, Intent data) {
        ...
        if (requestCode == SELECT_PICTURE && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            Toast.makeText(ChequeFragment.this.getContext(), "Select Payment Slip",
                    LENGTH_SHORT).show();
        }
    }
    ...
    private void callsubmit() {
        ...
        if(length < 800){
            okhttp3.RequestBody dt = okhttp3.RequestBody.create(okhttp3.MediaType.parse("text/plain"),"cheque");
            okhttp3.RequestBody transactiondate = okhttp3.RequestBody.create(okhttp3.MediaType.parse("text/plain"),strdate);
            okhttp3.RequestBody recept = okhttp3.RequestBody.create(okhttp3.MediaType.parse("text/plain"),strrn);
            ...
            okhttp3.RequestBody bankname = okhttp3.RequestBody.create(okhttp3.MediaType.parse("text/plain"),strbank);
            okhttp3.RequestBody chequeno = okhttp3.RequestBody.create(okhttp3.MediaType.parse("text/plain"),strcheque);
...
//            body = MultipartBody.Part.createFormData("file", file.getName().replace(" ", "_"), requestFile);
            ...
            Call<SendMultiplePinResponseModel> call = apiService.wsSendPinRequest("Bearer " + SharedPreferenceUtils.getAccesstoken(ChequeFragment.this.getContext()),map,body);
            ...
            Toast.makeText(ChequeFragment.this.getContext(), "Max Photo Size: 800 K.B.", LENGTH_SHORT).show();
        }
    ...
    private boolean validatedes() {
        ...
        if (strdes.isEmpty() ) {
            Toast.makeText(ChequeFragment.this.getContext(), "Enter Description", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
    ...
    private boolean validateRn() {
        ...
        if (strrn.isEmpty() ) {
            Toast.makeText(ChequeFragment.this.getContext(), "Enter Receipt No", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
    ...
    private boolean validatedate() {
        ...
        if (strdate.isEmpty() ) {
            Toast.makeText(ChequeFragment.this.getContext(), "Enter Valid Date", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
    ...
    private boolean validateAmount() {
        ...
        if (stramout.isEmpty() ) {
            Toast.makeText(ChequeFragment.this.getContext(), getString(R.string.enter_amount), Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    ...
    private void getusercartitem() {
        ...
        final Call<UserCartResponseModel> loginCall = apiService.wsGetUserCart(
                "Bearer " + SharedPreferenceUtils.getAccesstoken(ChequeFragment.this.getContext()));
...
//                            recycler_view_addtocart.setAdapter(addToCartAdapter);
            ...
            public void onFailure(Call<UserCartResponseModel> call,
                                  Throwable t) {
                Toast.makeText(ChequeFragment.this.getContext(), getString(R.string.something_went_wrong), Toast.LENGTH_SHORT).show();
            }
        });
    }
