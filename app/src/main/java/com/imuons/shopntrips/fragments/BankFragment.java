...
public class BankFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        etdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(BankFragment.this.getContext(), date, myCalendar
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(validateAmount() && validatedate() && validateRn() &&  validatedes() && validateBank()){
                    callsubmit();
                }
            }
        });
    ...
    private boolean validateBank() {
        ...
        if (strbank.isEmpty() ) {
            Toast.makeText(BankFragment.this.getContext(), "Enter Valid Bank Name", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
...
//                nfc.setText(filenamestr);
            ...
            Toast.makeText(BankFragment.this.getContext(), "Select Payment Slip",
                    LENGTH_SHORT).show();
        }
    }
    ...
    private void callsubmit() {
        ...
        if(length < 800){
            okhttp3.RequestBody dt = okhttp3.RequestBody.create(okhttp3.MediaType.parse("text/plain"),"bank");
...
//            body = MultipartBody.Part.createFormData("file", file.getName().replace(" ", "_"), requestFile);
            ...
            Call<SendMultiplePinResponseModel> call = apiService.wsSendPinRequest("Bearer " + SharedPreferenceUtils.getAccesstoken(BankFragment.this.getContext()),map,body);
            ...
            Toast.makeText(BankFragment.this.getContext(), "Max Photo Size: 800 K.B.", LENGTH_SHORT).show();
        }
    ...
    private boolean validatedes() {
        ...
        if (strdes.isEmpty() ) {
            Toast.makeText(BankFragment.this.getContext(), "Enter Valid Description", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
    ...
    private boolean validateRn() {
        ...
        if (strrn.isEmpty() ) {
            Toast.makeText(BankFragment.this.getContext(), "Enter Valid Receipt No", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
    ...
    private boolean validatedate() {
        ...
        if (strdate.isEmpty() ) {
            Toast.makeText(BankFragment.this.getContext(), "Enter Valid Date", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
    ...
    private boolean validateAmount() {
        ...
        if (stramout.isEmpty() ) {
            Toast.makeText(BankFragment.this.getContext(), getString(R.string.enter_amount), Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    ...
    private void getusercartitem() {
        ...
        final Call<UserCartResponseModel> loginCall = apiService.wsGetUserCart(
                "Bearer " + SharedPreferenceUtils.getAccesstoken(BankFragment.this.getContext()));
...
//                            recycler_view_addtocart.setAdapter(addToCartAdapter);
            ...
            public void onFailure(Call<UserCartResponseModel> call,
                                  Throwable t) {
                Toast.makeText(BankFragment.this.getContext(), getString(R.string.something_went_wrong), Toast.LENGTH_SHORT).show();
            }
        });
    }
