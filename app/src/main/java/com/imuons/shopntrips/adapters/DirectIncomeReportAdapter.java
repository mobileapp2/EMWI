...
public class DirectIncomeReportAdapter extends RecyclerView.Adapter<DirectIncomeReportAdapter.BinaryIncomeReportAdapterHolder> {
private List<DirectIncomeReportRecordModel> birList = new ArrayList<>();
private Context context;
private DirectIncomeReportFragment binaryIncomeReportFragment;
private String wdatefromurl,cdatefromurl;
private Date datec,datew;
private static int currentPosition = 0;

public DirectIncomeReportAdapter(Context context, List<DirectIncomeReportRecordModel> birList) {
...
@Override
public DirectIncomeReportAdapter.BinaryIncomeReportAdapterHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_direct_income_report, parent, false);
        return new DirectIncomeReportAdapter.BinaryIncomeReportAdapterHolder(v);
        }

@Override
public void onBindViewHolder(final DirectIncomeReportAdapter.BinaryIncomeReportAdapterHolder holder, final int position) {

final DirectIncomeReportRecordModel directIncomeReportRecordModel = birList.get(position);

        holder.hiddenlayout.setVisibility(View.GONE);
        wdatefromurl = directIncomeReportRecordModel.getEntryTime();
...
//        }
    ...
    holder.srno.setText(String.valueOf(position + 1));
        holder.amount.setText(directIncomeReportRecordModel.getAmount());
holder.fromfullname.setText(directIncomeReportRecordModel.getFullname());
    holder.fromuserid.setText(directIncomeReportRecordModel.getFromUserId());
